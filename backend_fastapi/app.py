...
from backend_fastapi.router.orcamentoMensalRouter import router as orcamento_mensal_router
...
app.include_router(orcamento_mensal_router, prefix='/OrcamentoMensal', tags=['Orcamento Mensal'])
